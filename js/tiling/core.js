              ...
              while (currentY < yEndLimit) {
                  ...
                  for (let c = startCol; c < numCols; c++) {
                      ...
                      if (isSquareRow) {
                          ...
                          const sqCenterX = cellBaseX + sideLength * centerOffsetRatio;
                          // Center Y within the current row's vertical space
                          const sqCenterY = currentY + actualSquareHeight * centerOffsetRatio;
                          outputCtx.save();
                          ...
                          // Center Y within the current row's vertical space
                          const triCenterY = currentY + actualTriHeight * centerOffsetRatio;
                          // Center X within the cell
                          const triCenterX = cellBaseX + sideLength * centerOffsetRatio;
                          ...
                          // and makes two drawTrianglePath/drawImage calls.
                      }
                  }
